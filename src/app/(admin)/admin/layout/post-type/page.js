      ...
      <div className="mt-8">
        <table className="text-sm w-full border">
          <thead className="font-medium bg-gray-700 border border-gray-700 text-white">
            <tr>
              <td className="border !border-gray-700 px-2">Display</td>
          ...
          <tbody>
            {postTypes?.map((data) => (
              <tr key={data._id} className="border-t border-gray-300">
                <td className="px-2 py-1">{data.displayName}</td>
                <td className="px-2 py-1">{data.slug}</td>
                <td className="text-center">
                  {data?.isActive ? (
                    <span className="text-green-700 bg-green-200 px-2 py-1 border border-green-600/70 text-xs rounded">
                      Active
                    </span>
                  ) : (
                    <span className="text-red-700 bg-red-200 px-2 py-1 border border-red-600/70 text-xs rounded">
                      Inactive
                    </span>
                  )}
                </td>
